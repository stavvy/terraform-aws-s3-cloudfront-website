output "s3_bucket_id" {
  value = aws_s3_bucket.main[0] ? aws_s3_bucket.main[0].id : ""
}

output "s3_bucket_arn" {
  value = aws_s3_bucket.main[0] ? aws_s3_bucket.main[0].arn : ""
}
...
output "s3_hosted_zone_id" {
  value = aws_s3_bucket.main[0] ? aws_s3_bucket.main[0].hosted_zone_id : ""
}
